...
<html>
    <head>
        ...
        <link href="b_listarMaterias.css" rel="stylesheet" type="text/css"/>
        <script src="b_listarMaterias.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <br>
        <a class="navbar-brand" href="b_servletMaterias">NUEVA MATERIA</a>
        <br>
        <table class="table">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              <th scope="row"><%=cont%></th>
                      <td>${mat.id}</td>
                      <td>${mat.nombre}</td>                       
                      <td><a href="b_servletMaterias?dat=${mat.id}" class="btn btn-outline-success" name="editar">EDITAR</a></td>
                      <td>
                          <form method="POST" action="b_servletListarMaterias">    
