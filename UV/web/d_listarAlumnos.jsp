...
<html>
    <head>
        ...
        <link href="d_listarAlumnos.css" rel="stylesheet" type="text/css"/>
        <script src="d_listarAlumnos.js" type="text/javascript"></script>
    ...
    <body>
        <h1>Alumnos</h1>
        <br>
        <a class="navbar-brand" href="c_servletAlumnos">NUEVO ALUMNO</a>
        <table class="table">
          <thead>
            <tr>
              <th scope="col">#</th>
          ...
          <tbody>
            ...
            <tr>
              <th scope="row"><%=cont%></th>
                      ...
                      <td>${alu.apellido}</td>
                      <td>${alu.dni}</td>
                      <td><a href="c_servletAlumnos?dat=${alu.legajo}" class="btn btn-outline-success" name="editar">EDITAR</a></td>
                      <td>
                          <form method="POST" action="c_servletListarAlumnos">    
                              <input type="hidden" value="${alu.legajo}" name="txt_idEliminar" id="txt_idEliminar">
