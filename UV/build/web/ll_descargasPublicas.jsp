...
<html>
    <head>
        ...
        <link href="ll_descargasPublicas.css" rel="stylesheet" type="text/css"/>
        <script src="ll_descargasPublicas.js" type="text/javascript"></script>        
        
    </head>
    <jsp:include page="z_cabezeraLogin.jsp" ></jsp:include>
    <jsp:include page="x_menu.jsp" ></jsp:include>
    <body>
        <h1>DESCARGAS DE MATERIAL PUBLICO</h1>
        <br>
         <div id="box">
                            ...
                            <tbody>                                
                                <g:forEach items="${aluxMamteria.listaRecursos}" var="recu">
                                    <tr>
                                        ...
                                        <td>${recu.formato}</td>
                                        <td>
                                            <form action="h_registrarDescargasPublicas?url=archivos/${recu.titulo}" method="POST" class="cargarDescarga" id="cargarDescarga" name="forFile">
